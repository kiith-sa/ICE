# -*- coding: utf-8 -*-
#
# ICE documentation build configuration file.
#
...
project = u'ICE'
copyright = (u'2010-2012, Dávid Horváth, Ferdinand Majerech, Libor Mališ.')
...
latex_documents = [
        ('index', 'ICE.tex', u'ICE Documentation',
...
man_pages = [
        ('index', 'dyaml', u'ICE Documentation',
